            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">
                            Use class <code>.text-primary</code>, <code>.text-secondary</code> etc. for text in theme
                            colors
                        </p>
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>
                            It is a long <mark class="bg-warning text-white">established</mark> fact that a reader will
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>
                            It is a long <span class="font-weight-bold">established fact</span> that a reader will be
