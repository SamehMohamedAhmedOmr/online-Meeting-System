    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-header top-card">{{ __('Staff.Create New rank') }}</div>
                    <div class="card-body">
                        <div class="p-3">
                        ...
                        <form method="POST" action="{{ url('rank') }}" accept-charset="UTF-8"
                            class="form-horizontal custom-form" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('admin.rank.form', ['formMode' => 'create'])
