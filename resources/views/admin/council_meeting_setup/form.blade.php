<div class="row">
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('meeting_number') ? 'has-error' : ''}}  ">
            <label for="meeting_number" class="control-label">{{__("Staff.Meetingnumber")}} <span style="color:red !important;">*</span></label>
            <input class="form-control" name="meeting_number" type="number" id="meeting_number" min='1'
                placeholder="{{ __('placeholder.Select Council') }}"
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('council_definition_id') ? 'has-error' : ''}}  ">
            <label for="council_definition_id" class="control-label">{{__("Staff.Definition Name")}} <span style="color:red !important;">*</span></label>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('meeting_date') ? 'has-error' : ''}}">
            <label for="datepicker" class="control-label">{{__("Staff.Meetingdate")}} <span style="color:red !important;">*</span></label>
            <input class="form-control" name="meeting_date" type="text" id="datepicker"
                placeholder="{{ __('placeholder.enter Meeting Date') }}"
                value="{{ isset($council_meeting_setup->meeting_date) ? $council_meeting_setup->meeting_date : old('meeting_date')}}" required>
            {!! $errors->first('meeting_date', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('meeting_time') ? 'has-error' : ''}}  ">
            <label for="meeting_time" class="control-label">{{__("Staff.Meetingtime")}} <span style="color:red !important;">*</span></label>
            <input class="form-control" name="meeting_time" type="text" id="timepicker"
                placeholder="{{ __('placeholder.enter Meeting Time') }}"
                value="{{ isset($council_meeting_setup->meeting_time) ? $council_meeting_setup->meeting_time : old('meeting_time')}}" required>
