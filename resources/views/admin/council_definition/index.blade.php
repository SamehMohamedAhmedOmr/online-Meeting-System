    ...
    <div class="content-wrapper">
        <div id="SuccessDelete" class="flash-message "
            ...
            <p class="alert alert-success text-white" style="text-align: center;"> &nbsp;
                Council Definition Deleted Successfully <i class="fas fa-check-double"></i></p>
        </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header d-flex justify-content-center">
                                        <h5 class="modal-title text-sm-center text-secondary" style="font-size: 14px;"
                                            ...
                                            councilDefinition will Delete Permanently , Are you sure ?
                                        </h5>
...
<script src="{{ URL::asset('js/ajax/getCouncilDefintion.js') }}" id='scriptDefinition' data-type="{{ Auth::user()->type }}"></script>
