$(function () {
    ...
    var targetURL = 'getDepartmentAjax';
    $('#get-data').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [{
                ...
                render: function (department_name) {
            ...
            },
            {
                ...
                render: function (data) {
                    edit = '<a href="department/' + data + '/edit" class="btn btn-sm btn-info text-white ml-2"><i class="fas fa-marker"></i> </a>';
